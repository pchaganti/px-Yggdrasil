...
describe.skipIf(!distExists)('structure aspect-status integration', () => {
  ...
  it('D8.3: draft toggle preserves structureTouchedFiles entry from prior enforced baseline', () => {
    ...
    const stfBefore = (baselineBefore.structureTouchedFiles as Record<string, unknown> | undefined)?.['has-readme'];
    ...
    const stfAfter = (baselineAfter.structureTouchedFiles as Record<string, unknown> | undefined)?.['has-readme'];
    // D8.3 carry-forward: draft-skipped structure aspects retain their prior structureTouchedFiles entry
